...
let sex = 'female', //будем использовать их в формуле функции ниже
    height, 
    weight, 
    age, 
    ratio = '1.375'; //дефолтные значения
...
function getStaticInformation(parentSelector, activeClass) {//функция для получения значений с элементов (div) страницы
